...
<style>
body{font-family:Arial,sans-serif;background:#111;color:#fff;padding:30px;text-align:center}
button{padding:16px 24px;border:0;border-radius:12px;font-size:18px;font-weight:bold}
#status{margin-top:20px;line-height:1.6}
</style>
</head>
<body>
